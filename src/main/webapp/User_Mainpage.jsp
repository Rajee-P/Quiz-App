...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-buttons">
            <button onclick="location.href='QuizMarks.jsp'">Previous Quizzes</button>
    ...
    <div class="container">
        ...
        <button class="create-quiz-btn" onclick="location.href='AttemptQuiz.jsp'">Attempt Quiz</button>
    </div>
